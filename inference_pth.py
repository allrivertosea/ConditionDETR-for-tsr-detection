...
def plot_results(pil_img, prob, boxes, output_path='output.jpg'):
...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='./conddetr_r50_epoch50_tsr/checkpoint0049.pth', help='resume from checkpoint')
...
def main(args):
    ...
    plot_results(im, probas[keep], bboxes_scaled, output_path='output.jpg')
